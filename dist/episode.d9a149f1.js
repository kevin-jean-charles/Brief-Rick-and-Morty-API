...
},{}],"lieux_episode/js/episode.js":[function(require,module,exports) {
...
var Episode = /*#__PURE__*/function () {
  function Episode() {
    ...
    _defineProperty(this, "saisonsFilters", ["S01", "S02", "S03", "S04"]);

    _fetchData(API_LINK.episode + "/" + Array.from({
      length: 41
    }, function (v, k) {
      return k + 1;
  ...
  _createClass(Episode, [{
    ...
    key: "addEventRadioButtons",
    value: function addEventRadioButtons() {
      var _this2 = this;

      var radios = document.querySelectorAll('.radios input');
      radios.forEach(function (radio) {
        radio.addEventListener('change', function (event) {
          var app_list = document.querySelector('.app_lists');
          app_list.innerHTML = "";
          var number_saison = parseInt(event.target.value.replace(/\D/g, ''));

          if (event.target.value !== "all") {
            var saisons = _this2.episodes.filter(function (saison) {
              return saison.episode.indexOf(event.target.value) > -1;
            });

            app_list.appendChild(_this2.createHeaderWithEpisodes(saisons, number_saison));
          } else {
    ...
    value: function createSectionEpisodes() {
      ...
      this.saisonsFilters.forEach(function (saisonFilter, index) {
        var episodes = _this3.episodes.filter(function (episode) {
          return episode.episode.indexOf(saisonFilter) > -1;
        });

        app_lists.appendChild(_this3.createHeaderWithEpisodes(episodes, index + 1));
      });
    }
  }, {
    key: "createEpisodes",
    value: function createEpisodes(episodes) {
      ...
      episodes.forEach(function (episode) {
        ...
        li.innerHTML += "<div class=\"app_card\">\n                                <div class=\"ribbon up\" style=\"--color: #8975b4;\">\n                                    <div class=\"content\">".concat(episode.characters.length, "</div>\n                                </div>\n                                <div class=\"app_card_body\">\n                                    <span class=\"app_card_label\">").concat(episode.episode, "</span>\n                                    <a data-url=\"").concat(episode.url, "\" href=\"#\" class=\"episode_name\">").concat(episode.name, "</a>\n                                    <span class=\"episode_air_date\">").concat(episode.air_date, "</span>\n                                </div>\n                                <div class=\"app_card_body_bg\"></div>\n                            </div>");
        li.querySelector('a').addEventListener('click', _this4.showDetails.bind(_this4));
        ul.append(li);
      });
      return ul;
    }
    ...
    value: function showDetails(e) {
      ...
      _fetchData(e.target.dataset.url).then(function (episode) {
        Promise.all(episode.characters.map(function (url) {
          return _fetchData(url);
        })).then(function (resp) {
          return Promise.all(resp.map(function (res) {
            return res;
          }));
        }).then(function (characteres) {
          _this5.characters = characteres;

          _this5.createCharacters();

          var cpt = 0;
          document.getElementById("myNav").style.width = "100%";
          var decks = document.querySelectorAll(".overlay-content .deck");
          decks.forEach(function (elem, index) {
            setTimeout(function () {
    ...
    value: function createCharacters() {
      ...
      this.characters.forEach(function (character) {
        overlay_content.innerHTML += _this6.createCharacter(character);
      });
    }
  }, {
    key: "createCharacter",
    value: function createCharacter(character) {
      return "<div class=\"deck\">\n                    <div class=\"card hovercard\">\n                        <div class=\"front face\">\n                            <h2>Rick and Morty</h2>\n                            <div class=\"bottext\">\n                        </div>\n                    </div>\n                    <div class=\"back face\">\n                        <h2>".concat(character.name, "</h2>\n                        <ul>\n                            <li><img src=\"").concat(character.image, "\"/></li>\n                            <li>Genre: ").concat(character.gender, "</li>\n                            <li>\xC8sp\xE8ce: ").concat(character.species, "</li>\n                            <li>Status: ").concat(character.status, "</li>\n                        </ul>\n                        <div class=\"botprice\">\n                            <h3>Type: ").concat(character.type !== "" ? character.type : "Unknown", "</h3>\n                        </div>\n                    </div>\n                    </div>\n                </div>");
    }
  }, {
    key: "createHeaderWithEpisodes",
    value: function createHeaderWithEpisodes(episodes, i) {
...
},{}]},{},["../../../../.nvm/versions/node/v14.10.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","lieux_episode/js/episode.js"], null)
//# sourceMappingURL=/episode.d9a149f1.js.map